        ...
        for (Result result :resultScanner) {
            ...
            for (Cell  cell : cells) {
                ...
                if(null != col && col.equals("imei")){
                   ...
                   String deviceId = new String(CellUtil.cloneValue(cell));

                   if(deviceId != null){
                       lngAndLat.setDeviceId(deviceId);
                   }
                ...
                if(null !=col  && col.equals("time")){
                    ...
                    String date = new String(CellUtil.cloneValue(cell));

                    if(!StringUtil.isEmpty(date)){
                        lngAndLat.setDate(DateUtils.parseDate(date,DateUtils.DATETIME_FORMAT));
                    }
                }
